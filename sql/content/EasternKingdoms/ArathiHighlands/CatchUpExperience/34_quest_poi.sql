...
-- Server mapID: 2796   client uiMapID **2451** (Arathi Highlands worldmap tile -- used
...
--   908xx row (QuestID=90882, MapID=2927, UiMapID=2451) -- MapID 2927 does not match this
--   zone's server map 2796, so it is treated as unreliable WDB-cache noise (consistent
--   with 90882/90883's blank-text WDB rows, see 30_quest_template.sql) and NOT reused;
...
INSERT INTO `quest_poi` (`QuestID`, `BlobIndex`, `Idx1`, `ObjectiveIndex`, `QuestObjectiveID`, `QuestObjectID`, `MapID`, `UiMapID`, `Priority`, `Flags`, `WorldEffectID`, `PlayerConditionID`, `NavigationPlayerConditionID`, `SpawnTrackingID`, `AlwaysAllowMergingBlobs`) VALUES
 (90882, 1, 1, 0, 0, 0,      2796, 2451, 0, 0, 0, 0, 0, 0, 0),  -- Hammerfall (Part 1.7): 5 gnoll entries, multi-target
 (90883, 1, 1, 0, 0, 0,      2796, 2451, 0, 0, 0, 0, 0, 0, 0),  -- Go'shek/Dabyrie's Farmstead (Part 1.7): travel destination
 (90885, 1, 1, 0, 0, 244956, 2796, 2451, 0, 0, 0, 0, 0, 0, 0),  -- Go'shek farm: Prized Pumpkin
 (90886, 1, 1, 0, 0, 0,      2796, 2451, 0, 0, 0, 0, 0, 0, 0),  -- Go'shek farm: item drops off farm mobs
 (90887, 1, 1, 0, 0, 244675, 2796, 2451, 0, 0, 0, 0, 0, 0, 0),  -- Go'shek farm: Runk
 (90888, 1, 1, 0, 0, 0,      2796, 2451, 0, 0, 0, 0, 0, 0, 0),  -- Stromgarde Keep (Part 1.7): travel destination
 (90893, 1, 1, 0, 0, 0,      2796, 2451, 0, 0, 0, 0, 0, 0, 0),  -- Stromgarde siege battlefield (Part 1.3): multi-target progress bar
 (90895, 1, 1, 0, 0, 249269, 2796, 2451, 0, 0, 0, 0, 0, 0, 0),  -- Catapults cluster (Part 1.3)
 (90896, 1, 1, 0, 0, 244709, 2796, 2451, 0, 0, 0, 0, 0, 0, 0),  -- siege battlefield: Ro'grok (former Horde encampment)
 (90897, 1, 1, 0, 0, 244714, 2796, 2451, 0, 0, 0, 0, 0, 0, 0),  -- Stromgarde battlefield: Jaina @ Part 1.3 cluster coords
 (90911, 1, 1, 0, 0, 244714, 2796, 2451, 0, 0, 0, 0, 0, 0, 0)   -- Stromgarde battlefield: Jaina hub (same spot as 90897)
