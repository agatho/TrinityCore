-- ========================================================================================
-- CONTENT SLICE -- Waking Shores (map 2927) :: spawn reconcile across 6 captures
-- ========================================================================================
...
-- spawntimesecs: 0 measured, 77 from realm siblings, 1 fallback (300s). Per-row provenance below.
...
-- 203 row(s) from WANDERING entries were skipped: a roaming creature is captured
...
DELETE FROM `creature` WHERE `guid` BETWEEN 8200000 AND 8200077;
INSERT INTO `creature` (`guid`,`id`,`map`,`PhaseId`,`position_x`,`position_y`,`position_z`,`orientation`,`spawntimesecs`,`MovementType`) VALUES
 ...
 (8200040, 244671, 2927, 1961, -1024.5676, -3492.6140, 62.2881, 1.9298, 60, 0),  -- sources=wpp_horde phase=inherited from guid 8000022 spawntime=60s realm siblings (3 of 3 existing spawns of this entry; consistency, not a measurement)
 (8200041, 244672, 2927, 1961, -960.0677, -3510.1440, 57.0754, 3.3031, 60, 0),  -- sources=wpp_alliance+wpp_alliance2+wpp_alliance3 phase=inherited from guid 8000205 spawntime=60s realm siblings (3 of 3 existing spawns of this entry; consistency, not a measurement)
 (8200042, 244682, 2927, 28, -1211.0911, -1924.6592, 89.9463, 0.6272, 60, 0),  -- sources=wpp_alliance2 phase=inherited from guid 8000162 spawntime=60s realm siblings (12 of 12 existing spawns of this entry; consistency, not a measurement)
 (8200043, 244682, 2927, 28, -1272.6553, -1744.4030, 54.8045, 4.5671, 60, 0),  -- sources=wpp_alliance2 phase=inherited from guid 8000171 spawntime=60s realm siblings (12 of 12 existing spawns of this entry; consistency, not a measurement)
 (8200044, 244682, 2927, 28, -1372.9844, -1770.0330, 61.7927, 2.7351, 60, 0),  -- sources=wpp_alliance2 phase=inherited from guid 8000079 spawntime=60s realm siblings (12 of 12 existing spawns of this entry; consistency, not a measurement)
 (8200045, 244683, 2927, 28, -1257.2750, -1661.6400, 48.0991, 2.8342, 60, 0),  -- sources=wpp_alliance2 phase=inherited from guid 8000133 spawntime=60s realm siblings (7 of 7 existing spawns of this entry; consistency, not a measurement)
 (8200046, 244683, 2927, 28, -1333.1406, -1804.9791, 61.8244, 1.3773, 60, 0),  -- sources=wpp_alliance2 phase=inherited from guid 8000176 spawntime=60s realm siblings (7 of 7 existing spawns of this entry; consistency, not a measurement)
 (8200047, 244683, 2927, 28, -1245.6160, -1643.4630, 48.0943, 5.0648, 60, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8000133 spawntime=60s realm siblings (7 of 7 existing spawns of this entry; consistency, not a measurement)
 (8200048, 244690, 2927, 1610, -1310.9116, -1676.6160, 51.8776, 2.1874, 300, 0),  -- sources=wpp_alliance2+wpp_alliance3 phase=inherited from guid 8000077 spawntime=300s realm siblings (8 of 8 existing spawns of this entry; consistency, not a measurement)
 (8200049, 244690, 2927, 1610, -1464.7189, -1794.4075, 67.6618, 0.8789, 300, 0),  -- sources=wpp_alliance2+wpp_alliance3 phase=inherited from guid 8300046 spawntime=300s realm siblings (8 of 8 existing spawns of this entry; consistency, not a measurement)
 (8200050, 244690, 2927, 1610, -1462.6290, -1797.0267, 67.1950, 1.2856, 300, 0),  -- sources=wpp_alliance2+wpp_alliance3 phase=inherited from guid 8300046 spawntime=300s realm siblings (8 of 8 existing spawns of this entry; consistency, not a measurement)
 (8200051, 244690, 2927, 1610, -1312.1323, -1656.1215, 53.3354, 5.5975, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8000078 spawntime=300s realm siblings (8 of 8 existing spawns of this entry; consistency, not a measurement)
 (8200052, 244690, 2927, 1610, -1314.0745, -1658.9636, 52.8979, 5.8544, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8000076 spawntime=300s realm siblings (8 of 8 existing spawns of this entry; consistency, not a measurement)
 (8200053, 244690, 2927, 1610, -1427.4785, -1987.3053, 44.2941, 1.6341, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8000075 spawntime=300s realm siblings (8 of 8 existing spawns of this entry; consistency, not a measurement)
 (8200054, 244690, 2927, 1610, -1411.5309, -1968.1030, 50.6217, 3.7830, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8000072 spawntime=300s realm siblings (8 of 8 existing spawns of this entry; consistency, not a measurement)
 (8200055, 244690, 2927, 1610, -1290.2808, -1663.8817, 52.5375, 3.3398, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8000076 spawntime=300s realm siblings (8 of 8 existing spawns of this entry; consistency, not a measurement)
 (8200056, 244690, 2927, 1610, -1430.5547, -1965.6328, 47.5978, 5.3759, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8000075 spawntime=300s realm siblings (8 of 8 existing spawns of this entry; consistency, not a measurement)
 (8200057, 244695, 2927, 28, -1417.2076, -1965.2820, 49.1634, 0.0688, 300, 0),  -- sources=wpp_alliance2 phase=inherited from guid 8300055 spawntime=300s realm siblings (3 of 3 existing spawns of this entry; consistency, not a measurement)
 (8200058, 244695, 2927, 28, -1330.1991, -1869.5917, 61.8718, 1.2816, 300, 0),  -- sources=wpp_alliance2 phase=inherited from guid 8300056 spawntime=300s realm siblings (3 of 3 existing spawns of this entry; consistency, not a measurement)
 (8200059, 244695, 2927, 28, -1318.7188, -1665.6024, 51.8927, 5.0599, 300, 0),  -- sources=wpp_alliance2 phase=inherited from guid 8000080 spawntime=300s realm siblings (3 of 3 existing spawns of this entry; consistency, not a measurement)
 (8200060, 244695, 2927, 28, -1358.2916, -1937.5365, 58.2608, 1.1043, 300, 0),  -- sources=wpp_alliance2 phase=inherited from guid 8300056 spawntime=300s realm siblings (3 of 3 existing spawns of this entry; consistency, not a measurement)
 (8200061, 244711, 2927, 28, -845.6597, -2025.1423, 56.2242, 3.7937, 120, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8000111 spawntime=120s realm siblings (36 of 36 existing spawns of this entry; consistency, not a measurement)
 (8200062, 244711, 2927, 28, -884.6042, -2096.9653, 61.3475, 2.1356, 120, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8000093 spawntime=120s realm siblings (36 of 36 existing spawns of this entry; consistency, not a measurement)
 (8200063, 244785, 2927, 28, -1024.3142, -1979.8680, 60.8178, 1.3496, 120, 0),  -- sources=wpp_alliance2+wpp_alliance3 phase=inherited from guid 8000120 spawntime=120s realm siblings (5 of 5 existing spawns of this entry; consistency, not a measurement)
 (8200064, 244785, 2927, 28, -1003.8351, -1999.3021, 59.9970, 2.6882, 120, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8000121 spawntime=120s realm siblings (5 of 5 existing spawns of this entry; consistency, not a measurement)
 (8200065, 244786, 2927, 28, -1016.8507, -1963.2413, 60.7704, 0.8590, 60, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8000127 spawntime=60s realm siblings (6 of 6 existing spawns of this entry; consistency, not a measurement)
 (8200066, 244956, 2927, 1959, -1553.7274, -2959.6580, 14.0230, 0.0000, 300, 0),  -- sources=wpp_alliance2 phase=inherited from guid 8000031 spawntime=300s realm siblings (4 of 4 existing spawns of this entry; consistency, not a measurement)
 (8200067, 249255, 2927, 4, -1517.2344, -3085.9583, 26.7478, 4.6013, 60, 0),  -- sources=wpp_alliance2+wpp_alliance3 phase=inherited from guid 8000041 spawntime=60s realm siblings (5 of 5 existing spawns of this entry; consistency, not a measurement)
 (8200068, 249255, 2927, 4, -1518.9427, -3082.7222, 26.2588, 4.7994, 60, 0),  -- sources=wpp_alliance3+wpp_horde phase=inherited from guid 8000041 spawntime=60s realm siblings (5 of 5 existing spawns of this entry; consistency, not a measurement)
 (8200069, 249351, 2927, 0, -1524.0399, -1854.9740, 69.0330, 3.0474, 300, 0),  -- sources=rpe_h2_proj+wpp_alliance2 phase=DEFAULT (no neighbour) spawntime=300s FALLBACK -- no measured cadence and no realm sibling to inherit from
 (8200070, 254547, 2927, 1959, -1144.1488, -1890.6250, 79.9442, 3.1416, 300, 0),  -- sources=wpp_alliance2 phase=inherited from guid 8001091 spawntime=300s realm siblings (13 of 13 existing spawns of this entry; consistency, not a measurement)
 (8200071, 254547, 2927, 1959, -1412.1482, -1962.0024, 49.3261, 6.2167, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8001091 spawntime=300s realm siblings (13 of 13 existing spawns of this entry; consistency, not a measurement)
 (8200072, 254547, 2927, 1959, -1639.2284, -1780.9406, 80.0089, 2.2064, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8001088 spawntime=300s realm siblings (13 of 13 existing spawns of this entry; consistency, not a measurement)
 (8200073, 254547, 2927, 1959, -1619.2238, -1801.6873, 79.8405, 0.0509, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8001088 spawntime=300s realm siblings (13 of 13 existing spawns of this entry; consistency, not a measurement)
 (8200074, 254547, 2927, 1959, -1689.7659, -1713.2081, 73.2150, 4.6831, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8001094 spawntime=300s realm siblings (13 of 13 existing spawns of this entry; consistency, not a measurement)
 (8200075, 254547, 2927, 1959, -1637.4282, -1806.2694, 80.0095, 4.4193, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8001088 spawntime=300s realm siblings (13 of 13 existing spawns of this entry; consistency, not a measurement)
 (8200076, 254547, 2927, 1959, -1646.6788, -1835.1832, 80.0089, 1.1964, 300, 0),  -- sources=wpp_alliance3 phase=inherited from guid 8001088 spawntime=300s realm siblings (13 of 13 existing spawns of this entry; consistency, not a measurement)
 (8200077, 254547, 2927, 1610, -1141.7675, -1878.9631, 82.1625, 2.0344, 300, 0);  -- sources=wpp_alliance3 phase=inherited from guid 8000203 spawntime=300s realm siblings (13 of 13 existing spawns of this entry; consistency, not a measurement)

-- ledger (tools/zone_census_report.py artifacts.txt):
-- TCHarvest capture-ARTIFACT + REVIEW ledger
-- ==========================================
-- map=2927 table=creature captures=6
-- 
...
-- 
-- candidate entries: 38 | emitted: 26 | excluded as artifacts: 0 | held for review: 12
-- 
...
--   entry 234884   Highlands Lumberjack             seen in only 1 capture (wpp_alliance2) -- HELD FOR REVIEW, not deleted: this bucket also holds real content only one run happened to see
...
-- 
-- EMITTED -- corroborated content (26)
--   entry 141725   Burning Exile                    corroborated by 3 captures (rpe_a4_proj, wpp_alliance, wpp_alliance3)
...
--   entry 142566   Drywhisker Kobold                corroborated by 3 captures (rpe_a4_proj, wpp_alliance2, wpp_horde)
--   entry 142694   Boulderfist Enforcer             corroborated by 6 captures (rpe_a4_proj, rpe_h2_proj, wpp_alliance, wpp_alliance2, wpp_alliance3, wpp_horde)
--   entry 230001   Stromgarde Orphan                corroborated by 3 captures (wpp_alliance, wpp_alliance3, wpp_horde)
--   entry 230004   Beggar                           corroborated by 4 captures (rpe_a4_proj, rpe_h2_proj, wpp_alliance2, wpp_horde)
...
--   entry 231309   Stromic Engineer                 corroborated by 5 captures (rpe_a4_proj, wpp_alliance, wpp_alliance2, wpp_alliance3, wpp_horde)
--   entry 244671   Gnoll Ripper                     corroborated by 6 captures (rpe_a4_proj, rpe_h2_proj, wpp_alliance, wpp_alliance2, wpp_alliance3, wpp_horde)
--   entry 244672   Gnoll Bruiser                    corroborated by 5 captures (rpe_h2_proj, wpp_alliance, wpp_alliance2, wpp_alliance3, wpp_horde)
--   entry 244682   Kobold Waxmancer                 corroborated by 4 captures (rpe_a4_proj, rpe_h2_proj, wpp_alliance2, wpp_horde)
--   entry 244683   Gnoll Prowler                    corroborated by 5 captures (rpe_a4_proj, rpe_h2_proj, wpp_alliance2, wpp_alliance3, wpp_horde)
--   entry 244690   Stromgarde Footman               corroborated by 6 captures (rpe_a4_proj, rpe_h2_proj, wpp_alliance, wpp_alliance2, wpp_alliance3, wpp_horde)
--   entry 244695   Ettin Crusher                    corroborated by 2 captures (wpp_alliance2, wpp_horde)
--   entry 244711   Armored Cleaver                  corroborated by 6 captures (rpe_a4_proj, rpe_h2_proj, wpp_alliance, wpp_alliance2, wpp_alliance3, wpp_horde)
--   entry 244785   Armored Cleaver                  corroborated by 6 captures (rpe_a4_proj, rpe_h2_proj, wpp_alliance, wpp_alliance2, wpp_alliance3, wpp_horde)
--   entry 244786   Gnoll Charger                    corroborated by 6 captures (rpe_a4_proj, rpe_h2_proj, wpp_alliance, wpp_alliance2, wpp_alliance3, wpp_horde)
--   entry 244956   Prized Pumpkin                   corroborated by 4 captures (rpe_a4_proj, rpe_h2_proj, wpp_alliance2, wpp_horde)
--   entry 249255   Kobold Pillager                  corroborated by 6 captures (rpe_a4_proj, rpe_h2_proj, wpp_alliance, wpp_alliance2, wpp_alliance3, wpp_horde)
--   entry 249351   Fightbot Version 11.2.7          corroborated by 2 captures (rpe_h2_proj, wpp_alliance2)
