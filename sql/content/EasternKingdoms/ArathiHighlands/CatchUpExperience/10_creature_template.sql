...
-- reaction (faction 14); flagged for Phase K narrative confirmation.
  -- entry 244642 Thrall [reaction=2 was Alliance-POV artifact -> CORRECTED to faction=35 via POV-independent wire FactionTemplate (714/2361 Horde-ally; Hammerfall Peon 249249 same-template reads friendly). Horde screenshots confirm GREEN. Shared-story ally.]
INSERT INTO `creature_template` (`entry`, `name`, `faction`, `npcflag`, `rank`, `type`, `unit_class`) VALUES (244642, 'Thrall', 35, 0, 1, 7, 8) ON DUPLICATE KEY UPDATE `name`=VALUES(`name`), `faction`=VALUES(`faction`), `npcflag`=VALUES(`npcflag`), `rank`=VALUES(`rank`), `type`=VALUES(`type`), `unit_class`=VALUES(`unit_class`);
...
-- where Thrall clone 244642 also flips hostile (see above). Wire FactionTemplate (714/2361) + Horde capture PROVE these are Horde-friendly story allies (the reaction=2 was an Alliance-POV/quest-script artifact); CORRECTED to faction 35. Original (now-refuted) signal
...
INSERT INTO `creature_template` (`entry`, `name`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `rank`, `type`, `unit_class`) VALUES (244690, 'Stromgarde Footman', 20, 20, 35, 0, 0, 7, 1) ON DUPLICATE KEY UPDATE `name`=VALUES(`name`), `minlevel`=VALUES(`minlevel`), `maxlevel`=VALUES(`maxlevel`), `faction`=VALUES(`faction`), `npcflag`=VALUES(`npcflag`), `rank`=VALUES(`rank`), `type`=VALUES(`type`), `unit_class`=VALUES(`unit_class`);
  -- entry 230248 Hammerfall Grunt [reaction=2 was Alliance-POV artifact -> CORRECTED to faction=35 via POV-independent wire FactionTemplate (714/2361 Horde-ally; Hammerfall Peon 249249 same-template reads friendly). Horde screenshots confirm GREEN. Shared-story ally.]
INSERT INTO `creature_template` (`entry`, `name`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `rank`, `type`, `unit_class`) VALUES (230248, 'Hammerfall Grunt', 20, 20, 35, 0, 0, 7, 1) ON DUPLICATE KEY UPDATE `name`=VALUES(`name`), `minlevel`=VALUES(`minlevel`), `maxlevel`=VALUES(`maxlevel`), `faction`=VALUES(`faction`), `npcflag`=VALUES(`npcflag`), `rank`=VALUES(`rank`), `type`=VALUES(`type`), `unit_class`=VALUES(`unit_class`);
  -- entry 232019 Mag'har Grunt [reaction=2 was Alliance-POV artifact -> CORRECTED to faction=35 via POV-independent wire FactionTemplate (714/2361 Horde-ally; Hammerfall Peon 249249 same-template reads friendly). Horde screenshots confirm GREEN. Shared-story ally.]
INSERT INTO `creature_template` (`entry`, `name`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `rank`, `type`, `unit_class`) VALUES (232019, 'Mag''har Grunt', 20, 20, 35, 0, 0, 7, 1) ON DUPLICATE KEY UPDATE `name`=VALUES(`name`), `minlevel`=VALUES(`minlevel`), `maxlevel`=VALUES(`maxlevel`), `faction`=VALUES(`faction`), `npcflag`=VALUES(`npcflag`), `rank`=VALUES(`rank`), `type`=VALUES(`type`), `unit_class`=VALUES(`unit_class`);
  -- entry 232022 Drum Fel [reaction=2 was Alliance-POV artifact -> CORRECTED to faction=35 via POV-independent wire FactionTemplate (714/2361 Horde-ally; Hammerfall Peon 249249 same-template reads friendly). Horde screenshots confirm GREEN. Shared-story ally.]
INSERT INTO `creature_template` (`entry`, `name`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `rank`, `type`, `unit_class`) VALUES (232022, 'Drum Fel', 20, 20, 35, 0, 0, 7, 1) ON DUPLICATE KEY UPDATE `name`=VALUES(`name`), `minlevel`=VALUES(`minlevel`), `maxlevel`=VALUES(`maxlevel`), `faction`=VALUES(`faction`), `npcflag`=VALUES(`npcflag`), `rank`=VALUES(`rank`), `type`=VALUES(`type`), `unit_class`=VALUES(`unit_class`);
  -- entry 232023 Gor'mul [reaction=2 was Alliance-POV artifact -> CORRECTED to faction=35 via POV-independent wire FactionTemplate (714/2361 Horde-ally; Hammerfall Peon 249249 same-template reads friendly). Horde screenshots confirm GREEN. Shared-story ally.]
INSERT INTO `creature_template` (`entry`, `name`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `rank`, `type`, `unit_class`) VALUES (232023, 'Gor''mul', 20, 20, 35, 0, 0, 7, 1) ON DUPLICATE KEY UPDATE `name`=VALUES(`name`), `minlevel`=VALUES(`minlevel`), `maxlevel`=VALUES(`maxlevel`), `faction`=VALUES(`faction`), `npcflag`=VALUES(`npcflag`), `rank`=VALUES(`rank`), `type`=VALUES(`type`), `unit_class`=VALUES(`unit_class`);
  -- entry 232028 Korin Fel [reaction=2 was Alliance-POV artifact -> CORRECTED to faction=35 via POV-independent wire FactionTemplate (714/2361 Horde-ally; Hammerfall Peon 249249 same-template reads friendly). Horde screenshots confirm GREEN. Shared-story ally.]
INSERT INTO `creature_template` (`entry`, `name`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `rank`, `type`, `unit_class`) VALUES (232028, 'Korin Fel', 20, 20, 35, 0, 0, 7, 1) ON DUPLICATE KEY UPDATE `name`=VALUES(`name`), `minlevel`=VALUES(`minlevel`), `maxlevel`=VALUES(`maxlevel`), `faction`=VALUES(`faction`), `npcflag`=VALUES(`npcflag`), `rank`=VALUES(`rank`), `type`=VALUES(`type`), `unit_class`=VALUES(`unit_class`);
  -- entry 232030 Tharlidun [reaction=2 was Alliance-POV artifact -> CORRECTED to faction=35 via POV-independent wire FactionTemplate (714/2361 Horde-ally; Hammerfall Peon 249249 same-template reads friendly). Horde screenshots confirm GREEN. Shared-story ally.]
INSERT INTO `creature_template` (`entry`, `name`, `subname`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `rank`, `type`, `unit_class`) VALUES (232030, 'Tharlidun', 'Stable Master', 20, 20, 35, 0, 0, 7, 1) ON DUPLICATE KEY UPDATE `name`=VALUES(`name`), `subname`=VALUES(`subname`), `minlevel`=VALUES(`minlevel`), `maxlevel`=VALUES(`maxlevel`), `faction`=VALUES(`faction`), `npcflag`=VALUES(`npcflag`), `rank`=VALUES(`rank`), `type`=VALUES(`type`), `unit_class`=VALUES(`unit_class`);
  -- entry 232035 Keena [reaction=2 was Alliance-POV artifact -> CORRECTED to faction=35 via POV-independent wire FactionTemplate (714/2361 Horde-ally; Hammerfall Peon 249249 same-template reads friendly). Horde screenshots confirm GREEN. Shared-story ally.]
INSERT INTO `creature_template` (`entry`, `name`, `subname`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `rank`, `type`, `unit_class`) VALUES (232035, 'Keena', 'Trade Goods', 20, 20, 35, 0, 0, 7, 1) ON DUPLICATE KEY UPDATE `name`=VALUES(`name`), `subname`=VALUES(`subname`), `minlevel`=VALUES(`minlevel`), `maxlevel`=VALUES(`maxlevel`), `faction`=VALUES(`faction`), `npcflag`=VALUES(`npcflag`), `rank`=VALUES(`rank`), `type`=VALUES(`type`), `unit_class`=VALUES(`unit_class`);
  -- entry 232038 Uttnar [reaction=2 was Alliance-POV artifact -> CORRECTED to faction=35 via POV-independent wire FactionTemplate (714/2361 Horde-ally; Hammerfall Peon 249249 same-template reads friendly). Horde screenshots confirm GREEN. Shared-story ally.]
INSERT INTO `creature_template` (`entry`, `name`, `subname`, `minlevel`, `maxlevel`, `faction`, `npcflag`, `rank`, `type`, `unit_class`) VALUES (232038, 'Uttnar', 'Butcher', 20, 20, 35, 0, 0, 7, 1) ON DUPLICATE KEY UPDATE `name`=VALUES(`name`), `subname`=VALUES(`subname`), `minlevel`=VALUES(`minlevel`), `maxlevel`=VALUES(`maxlevel`), `faction`=VALUES(`faction`), `npcflag`=VALUES(`npcflag`), `rank`=VALUES(`rank`), `type`=VALUES(`type`), `unit_class`=VALUES(`unit_class`);

-- ---- HORDE CROSS-VALIDATION ADD (2026-08-20): Thrall Hammerfall hub NPC ----
-- 244715 Thrall = the Horde finale/hub NPC (quest 90898 ender + 90911 giver/ender), the exact
-- mirror of Alliance Jaina 244714. Exists in world DB ('Thrall'); we set faction 35 (friendly to
-- both, shared map) + npcflag gossip+questgiver. gossip_menu_id: the real Horde MenuID was NOT
-- wire-decoded (addon keyed it synthetically); by analogy to Jaina's 39348 it is a sibling (~39349)
-- -- LEFT UNSET (TODO Phase K: capture/datamine the real Thrall picker MenuID; option text
-- "Show me where I could go next." GossipOptionID 133894 is proven).
INSERT INTO `creature_template` (`entry`, `name`, `faction`, `npcflag`, `rank`, `type`, `unit_class`) VALUES (244715, 'Thrall', 35, 3, 1, 7, 8) ON DUPLICATE KEY UPDATE `faction`=VALUES(`faction`), `npcflag`=VALUES(`npcflag`);
