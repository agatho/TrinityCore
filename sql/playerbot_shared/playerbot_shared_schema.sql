-- ===========================================================================
-- PlayerbotV2 - SHARED DATABASE SCHEMA
-- ===========================================================================
-- Creates the shared playerbot schema and every object in it:
--   49 tables, 7 views, 10 stored routines, 2 triggers.
--
...
--
-- Table structure for table `handcrafted_road`
--
...
--
-- Table structure for table `playerbot_bot_templates`
--
...
--
-- Table structure for table `playerbot_bracket_statistics`
--
...
--
-- Table structure for table `playerbot_bracket_transitions`
--
...
--
-- Table structure for table `playerbot_class_race_matrix`
--
...
--
-- Table structure for table `playerbot_content_requirements`
--
...
--
-- Table structure for table `playerbot_dragonriding_glyph_templates`
--
...
--
-- Table structure for table `playerbot_dragonriding_glyphs`
--
...
--
-- Table structure for table `playerbot_dragonriding_talent_templates`
--
...
--
-- Table structure for table `playerbot_dragonriding_talents`
--
...
--
-- Table structure for table `playerbot_dungeon_routes`
--
...
--
-- Table structure for table `playerbot_friend_references`
--
...
--
-- Table structure for table `playerbot_instance_pool`
--
...
--
-- Table structure for table `playerbot_jit_bots`
--
...
--
-- Table structure for table `playerbot_lifecycle_metrics`
--
...
--
-- Table structure for table `playerbot_nav_links`
--
...
CREATE TABLE `playerbot_nav_links` (
  ...
  PRIMARY KEY (`id`),
  KEY `map_idx` (`map_id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='PlayerbotV2 human-verified traversal links (behavioral off-mesh alternative; see DungeonScript.h NavLink)';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Table structure for table `playerbot_player_activity`
--
...
--
-- Table structure for table `playerbot_pool_assignments`
--
...
--
-- Table structure for table `playerbot_pool_config`
--
...
--
-- Table structure for table `playerbot_pool_statistics`
--
...
--
-- Table structure for table `playerbot_protection_status`
--
...
--
-- Table structure for table `playerbot_retirement_queue`
--
...
--
-- Table structure for table `playerbot_spec_info`
--
...
--
-- Table structure for table `playerbot_template_actionbars`
--
...
--
-- Table structure for table `playerbot_template_config`
--
...
--
-- Table structure for table `playerbot_template_gear_items`
--
...
--
-- Table structure for table `playerbot_template_gear_sets`
--
...
--
-- Table structure for table `playerbot_template_statistics`
--
...
--
-- Table structure for table `playerbot_template_talents`
--
...
--
-- Table structure for table `playerbot_v2_world_metadata`
--
...
--
-- Table structure for table `playerbot_zone_demand`
--
...
--
-- Temporary view structure for view `v_gear_sets_overview`
--
...
--
-- Temporary view structure for view `v_pool_roles`
--
...
--
-- Temporary view structure for view `v_pool_status`
--
...
--
-- Temporary view structure for view `v_template_details`
--
...
--
-- Temporary view structure for view `v_templates_by_role`
--
...
--
-- Temporary view structure for view `v_warm_pool_bracket_summary`
--
...
--
-- Temporary view structure for view `v_warm_pool_health`
--
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `CleanupAssignmentHistory`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `CleanupPoolStatistics`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `cleanup_bracket_transitions`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `cleanup_lifecycle_metrics`()
BEGIN
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `GetBestTemplate`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `RecordTemplateUsage`(
...
/*!50003 SET sql_mode              = 'ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE  PROCEDURE `ValidateTemplate`(IN p_template_id INT UNSIGNED)
BEGIN
...
--
-- Final view structure for view `v_pool_roles`
--
...
--
-- Final view structure for view `v_pool_status`
--
...
--
-- Final view structure for view `v_template_details`
--
...
--
-- Final view structure for view `v_templates_by_role`
--
...
--
-- Final view structure for view `v_warm_pool_bracket_summary`
--
...
--
-- Final view structure for view `v_warm_pool_health`
--
