...
--
-- Table structure for table `character_recent_allies`
--
...
--
-- Table structure for table `character_recent_ally_settings`
--
...
--
-- Table structure for table `crafting_orders`
--
...
--
-- Table structure for table `crafting_order_reagents`
--
...
--
-- Table structure for table `character_weekly_reward_activity`
--
...
--
-- Table structure for table `character_weekly_reward_state`
--
...
--
-- Table structure for table `character_content_tracking`
--
