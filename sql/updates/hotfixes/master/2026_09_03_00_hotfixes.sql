--
-- BattlePets/PetBattle DB2 hotfix tables. feature/pet-battles added the DB2 loaders +
-- prepared statements (HotfixDatabase.cpp) but shipped no table SQL, so the worldserver
-- aborted at startup with "Could not prepare statements of the Hotfix database".
--
