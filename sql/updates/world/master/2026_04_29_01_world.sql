...
-- Map 2962, Scenario 3147, Difficulty 208, LfgDungeonsID 3025
-- Source: DoomCore drop (sniff 12.0.1.66527).
-- ============================================================
...
-- creature_template: bind ScriptName to the shared "Enter Delve" NPC.
UPDATE creature_template SET ScriptName = 'npc_delve_entrance' WHERE entry = 212407;

-- gameobject_template: bind the Leave Delve portal.
...
-- gossip_menu_addon: LfgDungeonsID drives the Blizzard_DelvesDifficultyPicker UI.
...
-- Delve Entry NPC Gossip menu rows.
