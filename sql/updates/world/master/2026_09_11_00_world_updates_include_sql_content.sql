-- Same registration as content/tww/arathi-rpe (2026_09_02_00_...): without this one row the
-- sql/content/DragonIsles/WakingShores slices on this branch are never applied by the updater.
-- ============================================================================
