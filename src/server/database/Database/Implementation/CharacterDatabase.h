...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_SEL_VAS_ACCOUNT_CHARACTER_LIST,
    ...
    CHAR_SEL_CHARACTER_QUESTSTATUS_LOREWALKING,
    CHAR_SEL_CHARACTER_LOREWALKING,
    ...
    CHAR_SEL_ACCOUNT_CHALLENGE_MODE_HISTORY,
    CHAR_SEL_MAILITEMS,
    ...
    CHAR_REP_ACCOUNT_CHALLENGE_MODE_HISTORY,
    CHAR_DEL_ACCOUNT_CHALLENGE_MODE_HISTORY,
    ...
    CHAR_UPD_GUILD_MOTD,
    CHAR_REP_GUILD_DISCORD_SETTINGS,
    CHAR_DEL_GUILD_DISCORD_SETTINGS,
    CHAR_SEL_CHAR_DISCORD_SETTINGS,
    CHAR_REP_CHAR_DISCORD_SETTINGS,
    CHAR_UPD_GUILD_INFO,
    ...
    CHAR_SEL_CRAFTING_ORDERS,
    CHAR_SEL_CRAFTING_ORDER_REAGENTS,
    CHAR_REP_CRAFTING_ORDER,
    CHAR_DEL_CRAFTING_ORDER,
    CHAR_DEL_CRAFTING_ORDER_REAGENTS,
    CHAR_INS_CRAFTING_ORDER_REAGENT,
    CHAR_INS_CRAFTING_ORDER_REPORT,
    ...
    CHAR_INS_CHARACTER,
    CHAR_UPD_CHARACTER,
    CHAR_UPD_CHARACTER_CREATE_MODE,
    CHAR_UPD_CHARACTER_TIMERUNNING_SEASON,

    CHAR_UPD_ADD_AT_LOGIN_FLAG,
    CHAR_UPD_REM_AT_LOGIN_FLAG,
    CHAR_UPD_ALL_AT_LOGIN_FLAGS,
    CHAR_UPD_CHARACTER_CHROMIE_TIME,
    CHAR_INS_BUG_REPORT,
    ...
    CHAR_SEL_WEEKLY_REWARD_STATE,
    CHAR_REP_WEEKLY_REWARD_STATE,
    CHAR_SEL_CONTENT_TRACKING,
    CHAR_REP_CONTENT_TRACKING,
    CHAR_DEL_CONTENT_TRACKING,
    CHAR_SEL_RECENT_ALLIES,
    CHAR_REP_RECENT_ALLY,
    CHAR_UPD_RECENT_ALLY_NOTE,
    CHAR_SEL_RECENT_ALLY_SETTING,
    CHAR_REP_RECENT_ALLY_SETTING,
    ...
    CHAR_DEL_CHAR_QUESTSTATUS_LOREWALKING,
    CHAR_DEL_CHARACTER_LOREWALKING,
    CHAR_REP_CHARACTER_LOREWALKING,
    ...
    CHAR_SEL_CHAR_PERKS_ACTIVITY,
    CHAR_INS_CHAR_PERKS_ACTIVITY,
    CHAR_DEL_CHAR_PERKS_ACTIVITY,
    CHAR_SEL_CHAR_PERKS_ACTIVITY_CRITERIA,
    CHAR_INS_CHAR_PERKS_ACTIVITY_CRITERIA,
    CHAR_DEL_CHAR_PERKS_ACTIVITY_CRITERIA,
    CHAR_DEL_CHAR_PERKS_ACTIVITY_CRITERIA_BY_CRITERIA,
    CHAR_REP_CHAR_QUESTSTATUS_OBJECTIVES_SPAWN_TRACKING,
    CHAR_DEL_CHAR_QUESTSTATUS_OBJECTIVES_SPAWN_TRACKING_BY_QUEST,
    CHAR_REP_CHAR_QUESTSTATUS_LOREWALKING,
    CHAR_DEL_CHAR_QUESTSTATUS_LOREWALKING_BY_QUEST,
    ...
    CHAR_UPD_CHARACTER_GARRISON_SHIPYARD,
    CHAR_DEL_CHARACTER_GARRISON,
    CHAR_SEL_CHARACTER_MYTHIC_PLUS,
    ...
    CHAR_SEL_CHARACTER_GARRISON_SPECIALIZATIONS,
    CHAR_INS_CHARACTER_GARRISON_SPECIALIZATIONS,
    CHAR_DEL_CHARACTER_GARRISON_SPECIALIZATIONS,
    ...
    CHAR_DEL_CHARACTER_GARRISON_SHIPMENT,

    CHAR_SEL_CHARACTER_GARRISON_TALENTS,
    CHAR_INS_CHARACTER_GARRISON_TALENT,
    CHAR_DEL_CHARACTER_GARRISON_TALENTS,
    CHAR_DEL_CHARACTER_GARRISON_TALENT,
    CHAR_DEL_CHARACTER_GARRISON_TEMPORARY_TALENTS_BY_TYPE,
    CHAR_SEL_CHARACTER_GARRISON_TROPHIES,
    CHAR_INS_CHARACTER_GARRISON_TROPHY,
    CHAR_DEL_CHARACTER_GARRISON_TROPHIES,
    CHAR_SEL_CHARACTER_GARRISON_ARCHIVED_MISSIONS,
    CHAR_INS_CHARACTER_GARRISON_ARCHIVED_MISSION,
    CHAR_DEL_CHARACTER_GARRISON_ARCHIVED_MISSIONS,
    CHAR_SEL_CHARACTER_GARRISON_BLUEPRINTS_BY_TYPE,
    CHAR_SEL_CHARACTER_GARRISON_BUILDINGS_BY_TYPE,
    CHAR_SEL_CHARACTER_GARRISON_SPECIALIZATIONS_BY_TYPE,
    CHAR_SEL_CHARACTER_GARRISON_FOLLOWERS_BY_TYPE,
    CHAR_SEL_CHARACTER_GARRISON_FOLLOWER_ABILITIES_BY_TYPE,
    CHAR_SEL_CHARACTER_GARRISON_MISSIONS_BY_TYPE,
    CHAR_SEL_CHARACTER_GARRISON_SHIPMENTS_BY_TYPE,
    CHAR_SEL_CHARACTER_GARRISON_TALENTS_BY_TYPE,
    CHAR_SEL_CHARACTER_GARRISON_TROPHIES_BY_TYPE,
    CHAR_SEL_CHARACTER_GARRISON_ARCHIVED_MISSIONS_BY_TYPE,

    // Queen's Conservatory (Night Fae unique sanctum feature) - one row per occupied wildseed plot.
    CHAR_SEL_CHARACTER_GARRISON_CONSERVATORY,
    CHAR_INS_CHARACTER_GARRISON_CONSERVATORY,
    CHAR_DEL_CHARACTER_GARRISON_CONSERVATORY,

    // Abomination Factory (Necrolord unique sanctum feature) - one row per built construct body.
    CHAR_SEL_CHARACTER_GARRISON_ABOMINATION,
    CHAR_INS_CHARACTER_GARRISON_ABOMINATION,
    CHAR_DEL_CHARACTER_GARRISON_ABOMINATION,

    // Path of Ascension (Kyrian unique sanctum feature, GarrTalentTree 320)
    CHAR_SEL_CHARACTER_GARRISON_ASCENSION,
    CHAR_INS_CHARACTER_GARRISON_ASCENSION,
    CHAR_DEL_CHARACTER_GARRISON_ASCENSION,

    // The Ember Court (Venthyr unique sanctum feature, GarrTalentTree 324)
    CHAR_SEL_CHARACTER_GARRISON_EMBER_COURT,
    CHAR_INS_CHARACTER_GARRISON_EMBER_COURT,
    CHAR_DEL_CHARACTER_GARRISON_EMBER_COURT,
    ...
    CHAR_INS_CHAR_RENOWN_REWARD_GRANTED,
    CHAR_INS_WARBAND_RENOWN_REWARD_GRANTED,
    ...
    CHAR_SEL_CHARACTER_SOULBIND_CONDUIT,
    CHAR_REP_CHARACTER_SOULBIND_CONDUIT,
    CHAR_SEL_CHARACTER_SOULBIND_CONDUIT_SOCKET,
    CHAR_REP_CHARACTER_SOULBIND_CONDUIT_SOCKET,
    CHAR_DEL_CHARACTER_SOULBIND_CONDUIT_SOCKET,
    CHAR_SEL_CHARACTER_COVENANT_RENOWN,
    CHAR_REP_CHARACTER_COVENANT_RENOWN,
    CHAR_SEL_CHARACTER_COVENANT_CALLINGS,
    CHAR_DEL_CHARACTER_COVENANT_CALLINGS,
    CHAR_INS_CHARACTER_COVENANT_CALLINGS,
    CHAR_DEL_CHARACTER_COVENANT,
    CHAR_DEL_CHARACTER_COVENANT_RENOWN,
    CHAR_DEL_CHARACTER_COVENANT_SOULBIND,
    CHAR_DEL_CHARACTER_SOULBIND_CONDUITS,
    CHAR_DEL_CHARACTER_SOULBIND_CONDUIT_SOCKETS,

    CHAR_SEL_CLUB_FINDER_POSTINGS,
    CHAR_REP_CLUB_FINDER_POSTING,
    CHAR_REP_CLUB_FINDER_APPLICATION,
    CHAR_DEL_CLUB_FINDER_APPLICATION,
    CHAR_UPD_CLUB_FINDER_POSTING_FLAGS,
    ...
    CHAR_SEL_DELVE_COMPANION,
    CHAR_REP_DELVE_COMPANION,
    CHAR_SEL_DELVE_PROGRESS,
    CHAR_REP_DELVE_PROGRESS,
    CHAR_UPD_RESET_DELVE_PROGRESS_WEEKLY,
    ...
    CHAR_UPD_ACCOUNT_BANK_COINAGE_DELTA,
    ...
    CHAR_SEL_ACCOUNT_REPUTATION,
    CHAR_REP_ACCOUNT_REPUTATION,

    CHAR_SEL_ACCOUNT_CHARACTER_CURRENCIES,
    CHAR_INS_WARBAND_CURRENCY_TRANSFER_LOG,
    CHAR_SEL_WARBAND_CURRENCY_TRANSFER_LOG,
    CHAR_UPD_PLAYER_CURRENCY_QUANTITY,
    CHAR_UPD_PLAYER_CURRENCY_QUANTITY_GUARDED,
    CHAR_UPD_CHARACTER_BNET_ACCOUNT,

    CHAR_SEL_WARBAND_TAXI_MASK,
    CHAR_REP_WARBAND_TAXI_MASK,
    CHAR_SEL_WARBAND_MAX_LEVEL_CHARS,

    CHAR_SEL_WARBAND_ACHIEVEMENTS,
    CHAR_SEL_WARBAND_ACHIEVEMENT_PROGRESS,
    CHAR_REP_WARBAND_ACHIEVEMENT,
    CHAR_REP_WARBAND_ACHIEVEMENT_PROGRESS,
    CHAR_DEL_WARBAND_ACHIEVEMENT_PROGRESS_BY_CRITERIA,

    CHAR_INS_CLUB_MESSAGE,
    CHAR_DEL_CLUB_MESSAGE_TRIM,
    CHAR_REP_CLUB_STREAM_VIEW_MARKER,
    CHAR_REP_CLUB_MENTION_VIEW_MARKER,
    CHAR_INS_CLUB_MEMBER_MENTION,
    CHAR_DEL_CLUB_MEMBER_MENTION,
    CHAR_SEL_GUILD_RENAME,
    CHAR_REP_GUILD_RENAME,
    CHAR_DEL_GUILD_RENAME,
