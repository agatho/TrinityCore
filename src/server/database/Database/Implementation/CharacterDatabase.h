...
enum CharacterDatabaseStatements : uint32
{
    ...
    */
    ...
    CHAR_INS_PET,
    CHAR_SEL_PET_FAVORITES,
    CHAR_INS_PET_FAVORITE,
    CHAR_DEL_PET_FAVORITE,
    ...
    CHAR_SEL_CHAR_RENOWN_REWARDS_GRANTED,
    CHAR_INS_CHAR_RENOWN_REWARD_GRANTED,
    CHAR_SEL_WARBAND_RENOWN_REWARDS_GRANTED,
