...
enum HotfixDatabaseStatements : uint32
{
    ...
    */
    ...
    HOTFIX_SEL_ACCOUNT_STORE_CATEGORY,
    HOTFIX_SEL_ACCOUNT_STORE_CATEGORY_MAX_ID,
    HOTFIX_SEL_ACCOUNT_STORE_CATEGORY_LOCALE,

    HOTFIX_SEL_ACCOUNT_STORE_ITEM,
    HOTFIX_SEL_ACCOUNT_STORE_ITEM_MAX_ID,
    HOTFIX_SEL_ACCOUNT_STORE_ITEM_LOCALE,
    ...
    HOTFIX_SEL_RENOWN_REWARDS_PLUNDERSTORM_MAX_ID,
    HOTFIX_SEL_RENOWN_REWARDS_PLUNDERSTORM_LOCALE,
    HOTFIX_SEL_COVENANT,
    ...
    HOTFIX_SEL_RAF_ACTIVITY,
    HOTFIX_SEL_RAF_ACTIVITY_MAX_ID,
    ...
    HOTFIX_SEL_ENCOUNTER_EVENT,
    HOTFIX_SEL_ENCOUNTER_EVENT_MAX_ID,
    ...
    HOTFIX_SEL_ITEM_CONVERSION,
    HOTFIX_SEL_ITEM_CONVERSION_MAX_ID,

    HOTFIX_SEL_ITEM_CONVERSION_ENTRY,
    HOTFIX_SEL_ITEM_CONVERSION_ENTRY_MAX_ID,
    ...
    HOTFIX_SEL_ITEM_LOGICAL_COST,
    HOTFIX_SEL_ITEM_LOGICAL_COST_MAX_ID,
    ...
    HOTFIX_SEL_MYTHIC_PLUS_SEASON_KEY_FLOOR,
    ...
    HOTFIX_SEL_PERKS_VENDOR_ITEM_X_INTERVAL_MAX_ID,
    ...
    HOTFIX_SEL_UI_ARROW_CALLOUT,
    HOTFIX_SEL_UI_ARROW_CALLOUT_MAX_ID,
    HOTFIX_SEL_UI_ARROW_CALLOUT_LOCALE,

    HOTFIX_SEL_UI_EVENT_TOAST,
    HOTFIX_SEL_UI_EVENT_TOAST_MAX_ID,
    HOTFIX_SEL_UI_EVENT_TOAST_LOCALE,

    HOTFIX_SEL_UI_GENERIC_WIDGET_DISPLAY,
    HOTFIX_SEL_UI_GENERIC_WIDGET_DISPLAY_MAX_ID,
    HOTFIX_SEL_UI_GENERIC_WIDGET_DISPLAY_LOCALE,
    ...
    HOTFIX_SEL_UI_PARTY_POSE,
    HOTFIX_SEL_UI_PARTY_POSE_MAX_ID,
    HOTFIX_SEL_UI_PARTY_POSE_LOCALE,
    ...
    HOTFIX_SEL_GARR_FOLLOWER_UI_CREATURE,
    HOTFIX_SEL_GARR_FOLLOWER_UI_CREATURE_MAX_ID,
    ...
    HOTFIX_SEL_GARR_PLOT_UI_CATEGORY,
    HOTFIX_SEL_GARR_PLOT_UI_CATEGORY_MAX_ID,
    HOTFIX_SEL_GARR_PLOT_UI_CATEGORY_LOCALE,
    ...
    HOTFIX_SEL_GARR_TALENT_RESEARCH,
    HOTFIX_SEL_GARR_TALENT_RESEARCH_MAX_ID,
    HOTFIX_SEL_GARR_TALENT_SOCKET_PROPERTIES,
    HOTFIX_SEL_GARR_TALENT_SOCKET_PROPERTIES_MAX_ID,
    HOTFIX_SEL_GARR_TALENT_MAP_POI,
    HOTFIX_SEL_GARR_TALENT_MAP_POI_MAX_ID,
    HOTFIX_SEL_GARR_TALENT_RANK_GROUP_ENTRY,
    HOTFIX_SEL_GARR_TALENT_RANK_GROUP_ENTRY_MAX_ID,
    HOTFIX_SEL_GARR_TALENT_RANK_GROUP_RESEARCH_MOD,
    HOTFIX_SEL_GARR_TALENT_RANK_GROUP_RESEARCH_MOD_MAX_ID,
    HOTFIX_SEL_GARR_TAL_TREE_X_GARR_TAL_RESEARCH,
    HOTFIX_SEL_GARR_TAL_TREE_X_GARR_TAL_RESEARCH_MAX_ID,
    ...
    HOTFIX_SEL_GOSSIP_X_GARR_TALENT_TREES,
    HOTFIX_SEL_GOSSIP_X_GARR_TALENT_TREES_MAX_ID,
    HOTFIX_SEL_TROPHY,
