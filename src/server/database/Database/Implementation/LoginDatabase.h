...
enum LoginDatabaseStatements : uint32
{
    ...
    */
    ...
    LOGIN_SEL_BNET_SOCIAL_CONTRACT_ACCEPTED,
    LOGIN_UPD_BNET_SOCIAL_CONTRACT_ACCEPTED,

    LOGIN_SEL_LAST_CHAR_UNDELETE,
    LOGIN_UPD_LAST_CHAR_UNDELETE,

    LOGIN_SEL_ACCOUNT_RAF_RECRUITS,
    LOGIN_INS_ACCOUNT_RAF_CODE,
    LOGIN_SEL_ACCOUNT_RAF_CLAIM_ELIGIBILITY,
    LOGIN_SEL_ACCOUNT_RAF_CLAIMED_ALL,
    LOGIN_INS_ACCOUNT_RAF_CLAIMED,
    LOGIN_DEL_ACCOUNT_RAF_RECRUIT,
    LOGIN_SEL_ACCOUNT_TOYS,
    LOGIN_REP_ACCOUNT_TOYS,
    LOGIN_DEL_ACCOUNT_TOYS,
    LOGIN_DEL_ACCOUNT_MOUNT,
    LOGIN_SEL_ACCOUNT_PERKS_PURCHASES,
    LOGIN_INS_ACCOUNT_PERKS_PURCHASE,
    LOGIN_DEL_ACCOUNT_PERKS_PURCHASE,
    LOGIN_SEL_ACCOUNT_PERKS_TENDER,
    LOGIN_REP_ACCOUNT_PERKS_TENDER,
    LOGIN_SEL_ACCOUNT_STORE_PURCHASES,
    LOGIN_INS_ACCOUNT_STORE_PURCHASE,
    LOGIN_DEL_ACCOUNT_STORE_PURCHASE,
    ...
    LOGIN_SEL_BNET_ITEM_NEW_APPEARANCES,
    LOGIN_INS_BNET_ITEM_NEW_APPEARANCE,
    LOGIN_DEL_BNET_ITEM_NEW_APPEARANCE,
    ...
    LOGIN_SEL_BNET_GAME_ACCOUNT_IDS,
    LOGIN_SEL_BNET_SOCIAL_CONTRACT,
    LOGIN_UPD_BNET_SOCIAL_CONTRACT,
    LOGIN_INS_BNET_REPORT,
    LOGIN_SEL_BNET_ITEM_FAVORITE_TRANSMOG_SETS,
    LOGIN_INS_BNET_ITEM_FAVORITE_TRANSMOG_SET,
    LOGIN_DEL_BNET_ITEM_FAVORITE_TRANSMOG_SET,
    ...
    LOGIN_INS_PAYPAL_SETTLEMENT,
    LOGIN_UPD_PAYPAL_SETTLEMENT_STATUS,
    LOGIN_SEL_PAYPAL_SETTLED,
    LOGIN_UPD_PAYPAL_DELIVERED,
