...
void WorldSession::HandleLfgJoinOpcode(WorldPackets::LFG::DFJoin& dfJoin)
{
    ...
    // Playerbot V2: solo player joined a dungeon queue. Auto-fill remaining role slots with bots.
    // Use the first selected dungeon as the target instance id. Bots themselves no-op the hook.
