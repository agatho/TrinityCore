...
enum WorldFloatConfigs : uint32
{
    ...
    // SMSG_SETUP_COMBAT_LOG_FILE_FLUSH (Familie 0x67) - der Client nimmt bei <= 0 seine
    // eigenen Vorgaben (0.8f bzw. 1.0f), siehe Konsument 0x1E0B270.
    CONFIG_COMBAT_LOG_FILE_THRESHOLD,
    CONFIG_COMBAT_LOG_FILE_FLUSH_INTERVAL,
...
enum WorldIntConfigs : uint32
{
    ...
    CONFIG_PERKS_PROGRAM_RESET_HOUR,
    ...
    CONFIG_BATTLEGROUND_INFO_THROTTLE_PERIOD,
    CONFIG_BATTLEGROUND_INFO_THROTTLE_BURST,
    ...
    // SMSG_SETUP_COMBAT_LOG_FILE_FLUSH (Familie 0x67)
    CONFIG_COMBAT_LOG_FILE_MAX_FILE_SIZE,
    CONFIG_COMBAT_LOG_FILE_MAX_SECONDS,
