...
class TC_GAME_API Spell
{
    ...
    public:
        ...
        void EffectTeleportToLfgDungeon();
        ...
        void EffectRestoreGarrisonTroopVitality();
        void EffectLearnGarrisonSpecialization();
        void EffectCreateShipment();
        void EffectUpgradeGarrison();
        void EffectAddGarrisonMission();
        void EffectSetFollowerQuality();
        void EffectIncreaseFollowerExperience();
        void EffectRandomizeFollowerAbilities();
        void EffectEndGarrisonBuildingConstruction();
        void EffectLearnFollowerAbility();
        void EffectFinishGarrisonMission();
        void EffectAddGarrisonMissionSet();
