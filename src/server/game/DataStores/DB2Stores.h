...
TC_GAME_API extern DB2Storage<GarrAbilityCategoryEntry>             sGarrAbilityCategoryStore;
TC_GAME_API extern DB2Storage<GarrAbilityEffectEntry>               sGarrAbilityEffectStore;
TC_GAME_API extern DB2Storage<GarrAutoCombatantEntry>               sGarrAutoCombatantStore;
TC_GAME_API extern DB2Storage<GarrAutoSpellEntry>                   sGarrAutoSpellStore;
TC_GAME_API extern DB2Storage<GarrAutoSpellEffectEntry>             sGarrAutoSpellEffectStore;
TC_GAME_API extern DB2Storage<GarrBuildingEntry>                    sGarrBuildingStore;
TC_GAME_API extern DB2Storage<GarrBuildingDoodadSetEntry>           sGarrBuildingDoodadSetStore;
...
TC_GAME_API extern DB2Storage<GarrClassSpecPlayerCondEntry>         sGarrClassSpecPlayerCondStore;
...
TC_GAME_API extern DB2Storage<GarrFollowerSetXFollowerEntry>         sGarrFollowerSetXFollowerStore;
TC_GAME_API extern DB2Storage<GarrFollowerUICreatureEntry>          sGarrFollowerUICreatureStore;
...
TC_GAME_API extern DB2Storage<GarrMissionTextureEntry>              sGarrMissionTextureStore;
TC_GAME_API extern DB2Storage<GarrMissionTypeEntry>                 sGarrMissionTypeStore;
TC_GAME_API extern DB2Storage<GarrMissionXEncounterEntry>           sGarrMissionXEncounterStore;
TC_GAME_API extern DB2Storage<GarrMissionXFollowerEntry>            sGarrMissionXFollowerStore;
TC_GAME_API extern DB2Storage<GarrMssnBonusAbilityEntry>            sGarrMssnBonusAbilityStore;
...
TC_GAME_API extern DB2Storage<GarrPlotUICategoryEntry>              sGarrPlotUICategoryStore;
...
TC_GAME_API extern DB2Storage<GarrSpecializationEntry>              sGarrSpecializationStore;
TC_GAME_API extern DB2Storage<GarrStringEntry>                      sGarrStringStore;
...
TC_GAME_API extern DB2Storage<GarrTalentResearchEntry>             sGarrTalentResearchStore;
TC_GAME_API extern DB2Storage<GarrTalentSocketPropertiesEntry>     sGarrTalentSocketPropertiesStore;
TC_GAME_API extern DB2Storage<GarrTalentMapPOIEntry>               sGarrTalentMapPOIStore;
TC_GAME_API extern DB2Storage<GarrTalentRankGroupEntryEntry>       sGarrTalentRankGroupEntryStore;
TC_GAME_API extern DB2Storage<GarrTalentRankGroupResearchModEntry> sGarrTalentRankGroupResearchModStore;
TC_GAME_API extern DB2Storage<GarrTalTreeXGarrTalResearchEntry>    sGarrTalTreeXGarrTalResearchStore;
TC_GAME_API extern DB2Storage<GarrTypeEntry>                        sGarrTypeStore;
TC_GAME_API extern DB2Storage<GarrUiAnimClassInfoEntry>             sGarrUiAnimClassInfoStore;
TC_GAME_API extern DB2Storage<GarrUiAnimRaceInfoEntry>              sGarrUiAnimRaceInfoStore;
...
TC_GAME_API extern DB2Storage<WeeklyRewardChestThresholdEntry>      sWeeklyRewardChestThresholdStore;
