...
namespace WorldPackets
{
    namespace BattlePay
    {
        ...
        // vector_resize. The earlier comment here claimed "u32 result, then a u32-counted vector", which
        // was wrong and cost a working shop - see PurchaseUpdate::Write.
        //
        // status = Done(3) signals completion and the record echoes the productID delivered;
        // status = ConfirmationPending(9) with resultCode 0 is what the confirmation dialog needs.
