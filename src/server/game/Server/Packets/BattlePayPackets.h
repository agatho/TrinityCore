...
namespace WorldPackets
{
    namespace BattlePay
    {
        ...
        // Proven against live sniffs: a retail account with 9 purchases produced a 413-byte body
        // (8 + 9 * 45), and the 68974 capture (10 purchases, 458 B = 8 + 10x45) fixes the record
        // order as u64+i32+i32+u32+u64+u64+i64+u8 - walletName length LAST (times align at
        // record offset 36; see the .cpp writer comment).
