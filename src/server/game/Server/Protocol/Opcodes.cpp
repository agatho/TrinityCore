...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    DEFINE_HANDLER(CMSG_COMMERCE_TOKEN_GET_COUNT,                           STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleCommerceTokenGetCount);
    ...
    DEFINE_HANDLER(CMSG_DO_COUNTDOWN,                                       STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleDoCountdown);
    ...
    DEFINE_HANDLER(CMSG_MAKE_CONTITIONAL_APPEARANCE_PERMANENT,              STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleMakeConditionalAppearancePermanent);
    ...
    DEFINE_HANDLER(CMSG_QUERY_PLAYER_NAMES_FOR_COMMUNITY,                   STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleQueryPlayerNamesForCommunity);
    DEFINE_HANDLER(CMSG_QUERY_PLAYER_NAME_BY_COMMUNITY_ID,                  STATUS_AUTHED,    PROCESS_THREADUNSAFE, &WorldSession::HandleQueryPlayerNameByCommunityId);
    ...
    DEFINE_HANDLER(CMSG_TOGGLE_DIFFICULTY,                                  STATUS_LOGGEDIN,  PROCESS_THREADUNSAFE, &WorldSession::HandleToggleDifficulty);
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ACCOUNT_UNKNOWN_COLLECTION_UPDATE_1,                          STATUS_UNHANDLED,   CONNECTION_TYPE_REALM);
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_ACCOUNT_UNKNOWN_COLLECTION_UPDATE_2,                          STATUS_UNHANDLED,   CONNECTION_TYPE_REALM);
    ...
    // Restored 2026-06-30 (12.0.7 sync): SMSG_HOUSING_EXPORT_HOUSE_RESPONSE re-added by upstream at 0x550003.
    ...
    // Retired 2026-05-12: SMSG_HOUSING_FIXTURE_DELETE_HOUSE_RESPONSE registration â€” opcode retired.
    ...
    // Retired 2026-05-12 (batch 2): SMSG_HOUSING_SVCS_CLEAR_PLOT_RESERVATION_RESPONSE registration.
    ...
    // Retired 2026-05-12 (batch 2): SMSG_HOUSING_SVCS_GUILD_APPEND_NEIGHBORHOOD_NOTIFICATION registration.
    ...
    DEFINE_SERVER_OPCODE_HANDLER(SMSG_TOTEM_REMOVED,                                                STATUS_NEVER,       CONNECTION_TYPE_REALM);
