...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    // 12.0.5 IDA-catalogued — opcodes the retail client sends but we haven't bound to handlers yet.
    // Wire format documented in docs/IDA_HOUSING_OPCODES_2026_04_26.md.
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_01,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_05,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_06,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_07,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_08,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_09,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_0A,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_0B,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_0C,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_0D,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_0E,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
    DEFINE_HANDLER(CMSG_NEIGHBORHOOD_INITIATIVE_OPCODE_0F,                  STATUS_UNHANDLED, PROCESS_THREADUNSAFE, &WorldSession::Handle_NULL);
