...
#define DEFINE_HANDLER(opcode, status, processing, handler) \
    ...
    // Retired 2026-05-12: CMSG_HOUSING_DECOR_CONFIRM_PREVIEW_PLACEMENT + DECOR_CLEANUP_MODE_TOGGLE handlers (fake CMSGs).
    ...
    // Retired 2026-05-12: CMSG_HOUSING_DECOR_DELETE_FROM_STORAGE_BY_ID handler (fake CMSG).
    ...
    // Retired 2026-05-12: CMSG_HOUSING_FIXTURE_CREATE_BASIC_HOUSE + DECOR_UPDATE_DYE_SLOT handlers (fake CMSGs).
    ...
    // Retired 2026-05-12: CMSG_HOUSING_FIXTURE_DELETE_HOUSE handler (fake CMSG; uses CMSG_HOUSING_SVCS_RELINQUISH_HOUSE instead).
    ...
    // Retired 2026-05-12 (batch 2): 8 fake SVCS CMSG handler registrations
    // (CLEAR_PLOT_RESERVATION, GET_ROSTER_DATA, ROSTER_UPDATE_SUBSCRIBE, REQUEST_PERMISSIONS_CHECK,
    //  QUERY_HOUSE_LEVEL_FAVOR, GUILD_APPEND_NEIGHBORHOOD, GUILD_RENAME_NEIGHBORHOOD, GUILD_GET_HOUSING_INFO).
    ...
    // Retired 2026-05-12: CMSG_HOUSING_SYSTEM_UPDATE_HOUSE_INFO + HOUSE_STATUS_QUERY handlers (fake CMSGs).
    // Retired 2026-05-11: CMSG_HOUSING_SYSTEM_HOUSE_SNAPSHOT handler registration.
    // Retired 2026-05-12: CMSG_HOUSING_SYSTEM_GET_HOUSE_INFO_ALT + EXPORT_HOUSE handlers (fake CMSGs).
    ...
    // Retired 2026-05-12: CMSG_NEIGHBORHOOD_CHARTER_REMOVE_SIGNATURE + CHARTER_SIGN_RESPONSE handlers (fake CMSGs).
...
#define DEFINE_SERVER_OPCODE_HANDLER(opcode, status, con) \
    ...
    // Retired 2026-05-12: SMSG_HOUSING_FIXTURE_DELETE_HOUSE_RESPONSE registration — opcode retired.
