...
TC_API_EXPORT EnumText EnumUtils<Races>::ToString(Races value)
{
    switch (value)
    {
        ...
        case RACE_HARRONIR_ALLIANCE: return { "RACE_HARRONIR_ALLIANCE", "Haranir", "Haranir (Alliance) (RaceMask bit 20)" };
        case RACE_HARRONIR_HORDE: return { "RACE_HARRONIR_HORDE", "Haranir", "Haranir (Horde) (RaceMask bit 19)" };
...
TC_API_EXPORT Races EnumUtils<Races>::FromIndex(size_t index)
{
    switch (index)
    {
        ...
        case 29: return RACE_HARRONIR_ALLIANCE;
        case 30: return RACE_HARRONIR_HORDE;
...
TC_API_EXPORT size_t EnumUtils<Races>::ToIndex(Races value)
{
    switch (value)
    {
        ...
        case RACE_HARRONIR_ALLIANCE: return 29;
        case RACE_HARRONIR_HORDE: return 30;
        default: throw std::out_of_range("value");
    }
}
}
