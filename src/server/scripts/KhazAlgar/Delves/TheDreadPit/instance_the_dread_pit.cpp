...
// Nerubian theme - The Ringing Deeps
...
static char const* const ScriptName = "the_dread_pit";
...
class instance_the_dread_pit : public InstanceMapScript
{
public:
    instance_the_dread_pit() : InstanceMapScript(ScriptName, 2684) { }
    ...
    {
        return new instance_the_dread_pit_InstanceScript(map);
    }
};
