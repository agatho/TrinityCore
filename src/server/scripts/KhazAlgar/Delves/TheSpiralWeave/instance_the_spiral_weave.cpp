...
static char const* const ScriptName = "the_spiral_weave";
...
class instance_the_spiral_weave : public InstanceMapScript
{
public:
    instance_the_spiral_weave() : InstanceMapScript(ScriptName, 2688) { }
    ...
    {
        return new instance_the_spiral_weave_InstanceScript(map);
    }
};
