...
static char const* const ScriptName = "the_underkeep";
...
class instance_the_underkeep : public InstanceMapScript
{
public:
    instance_the_underkeep() : InstanceMapScript(ScriptName, 2690) { }
    ...
    {
        return new instance_the_underkeep_InstanceScript(map);
    }
};
