...
// Kobold theme - The Ringing Deeps
...
static char const* const ScriptName = "the_waterworks";
...
class instance_the_waterworks : public InstanceMapScript
{
public:
    instance_the_waterworks() : InstanceMapScript(ScriptName, 2683) { }
    ...
    {
        return new instance_the_waterworks_InstanceScript(map);
    }
};
