...
static char const* const ScriptName = "tak_rethan_abyss";
...
class instance_tak_rethan_abyss : public InstanceMapScript
{
public:
    instance_tak_rethan_abyss() : InstanceMapScript(ScriptName, 2689) { }
    ...
    {
        return new instance_tak_rethan_abyss_InstanceScript(map);
    }
};
