...
static char const* const ScriptName = "kriegvals_rest";
...
class instance_kriegvals_rest : public InstanceMapScript
{
public:
    instance_kriegvals_rest() : InstanceMapScript(ScriptName, 2681) { }
    ...
    {
        return new instance_kriegvals_rest_InstanceScript(map);
    }
};
