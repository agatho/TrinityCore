...
for br in sorted(by):
    ...
    msg = (f"feat({br}): restore the dropped SQL data/schema layer for the 12.1 reconstruction\n\n"
           ...
           f"data. This restores {added} fork-custom SQL file(s) verbatim from the assembled\n"
           f"fork state (integration/all-systems) so the system persists and populates at runtime.\n\n"
